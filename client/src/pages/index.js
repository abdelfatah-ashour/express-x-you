...
export default function Home({ topTen }) {
  return (
    <>
      <Layout
        title="EXPRESS X YOU"
        ...
        <CarousalHome />
        <HomeCategories />
        {topTen && <TopTrend topTrends={topTen} />}
        <div className={Style.ExpressDescription + ' row'}>
          ...
          <div className="col-md-6 col-12 d-flex flex-column justify-content-center align-items-start">
            ...
            <p className="lead">
              Express x You is an ongoing design collaboration with our style
              community. Each season, we invite some of our best customers into
              the process. From helping us select prints and colors to wear
              testing new fits and fabrics, their input helps us design
              collections our customers will love.
            </p>
          </div>
        </div>
        <OurBrands />
